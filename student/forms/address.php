                    ...
                    <form class="address-form" novalidate method="post">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="liv_status" value="localite" required />
                                        <label class="form-check-label" for="localite">Localite</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="liv_status" value="hostalite" required />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <input type="text" name="perm_add1" class="form-control form-control-lg" maxlength="60" oninput="this.value = this.value.replace(/^\s+/g, '');" required />
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <input type="text" name="perm_add2" class="form-control form-control-lg" maxlength="60" oninput="this.value = this.value.replace(/^\s+/g, '');" required />
                                    <div class="invalid-feedback">Please fill address line !</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <input type="text" name="permanentcity" class="form-control form-control-lg" pattern="[A-Za-z]*" oninput="this.value=this.value.replace(/[^A-Za-z]/g,'');" required />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    <label class="form-label" for="add1">Address Line 1</label>
                                    <input type="text" name="pres_add1" class="form-control form-control-lg" maxlength="60" oninput="this.value = this.value.replace(/^\s+/g, '');" required />
                                    <div class="invalid-feedback">Please fill address line !</div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    <label class="form-label" for="add2">Address Line 2</label>
                                    <input type="text" name="pres_add2" class="form-control form-control-lg" maxlength="60" oninput="this.value = this.value.replace(/^\s+/g, '');" required />
                                    <div class="invalid-feedback">Please fill address line !</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    ...
                                    <input type="text" name="presentcity" class="form-control form-control-lg" pattern="[A-Za-z]*" oninput="this.value=this.value.replace(/[^A-Za-z]/g,'');" required />
                                    <div class="invalid-feedback">Please fill city !</div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
