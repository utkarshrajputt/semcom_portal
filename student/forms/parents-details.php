        ...
        <div class="col-12 col-lg-9 col-xl-7 w-100">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                <div class="card-body p-4 p-md-5">
                    <!-- FORM START -->
                    <form class="parents-details-form <?php echo isset($parent_dtl['p_id'])?'disable-form':''; ?>" novalidate method="post">
                            ...
                            <div class="col-md-6 mb-4 pb-5">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    <div class="form-group">
                                        ...
                                        <span style='font-size:1.3rem;font-weight:bold'><?php echo isset($parent_dtl['lang_father']) ? $parent_dtl['lang_father'] : ''; ?></span>
                                        <?php
                                            if(!(isset($parent_dtl['lang_father'])))
                                            {
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="fatherMobile" class="form-control form-control-lg" pattern="\d{10}" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required value="<?php echo isset($parent_dtl['fathers_mob']) ? $parent_dtl['fathers_mob'] : ''; ?>" />
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="fatherWhatsApp" id="fatherWhatsAppYes" value="yes" required <?php if(isset($parent_dtl['father_wp'])){if($parent_dtl['father_wp']=='yes'){ echo "checked"; }} ?> />
                                    <label class="form-check-label" for="fatherWhatsAppYes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="fatherWhatsApp" id="fatherWhatsAppNo" value="no" required <?php if(isset($parent_dtl['father_wp'])){if($parent_dtl['father_wp']=='no'){ echo "checked"; }} ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="email" name="fatherEmail" class="form-control form-control-lg" required value="<?php echo isset($parent_dtl['fathers_email']) ? $parent_dtl['fathers_email'] : ''; ?>" />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="fatherCompany" class="form-control form-control-lg" oninput="this.value = this.value.replace(/^\s+/g, '');" required value="<?php echo isset($parent_dtl['fathers_co']) ? $parent_dtl['fathers_co'] : ''; ?>" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4 pb-5">
                                ...
                                <div data-mdb-input-init class="form-outline gap-3">
                                    <label class="form-label">Language Known By Mother</label>
                                    <br> <span style='font-size:1.3rem;font-weight:bold'><?php echo isset($parent_dtl['lang_mother']) ? $parent_dtl['lang_mother'] : ''; ?> </span>
                                    <?php
                                        if(!(isset($parent_dtl['lang_mother'])))
                                        {
                                    ?>
                                                <br>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="motherMobile" class="form-control form-control-lg" pattern="\d{10}" maxlength="10" value="<?php echo isset($parent_dtl['mothers_mob']) ? $parent_dtl['mothers_mob'] : ''; ?> "  oninput="this.value=this.value.replace(/[^0-9]/g,'');" required />
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <!-- Mother whats app ? -->
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="motherWhatsApp" id="motherWhatsAppYes" value="yes" <?php if(isset($parent_dtl['mother_wp'])){if($parent_dtl['mother_wp']=='yes'){ echo "checked"; }} ?> required />
                                    <label class="form-check-label" for="motherWhatsAppYes">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="motherWhatsApp" id="motherWhatsAppNo" value="no" required <?php if(isset($parent_dtl['mother_wp'])){if($parent_dtl['mother_wp']=='no'){ echo "checked"; }} ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="email" name="motherEmail" class="form-control form-control-lg" required value="<?php echo isset($parent_dtl['mothers_email']) ? $parent_dtl['mothers_email'] : ''; ?> " />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="motherCompany" class="form-control form-control-lg" oninput="this.value = this.value.replace(/^\s+/g, '');" required value="<?php echo isset($parent_dtl['mothers_co']) ? $parent_dtl['mothers_co'] : ''; ?> " />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="emergencyMobile" class="form-control form-control-lg" pattern="\d{10}" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required value="<?php echo isset($parent_dtl['emergency_mob']) ? $parent_dtl['emergency_mob'] : ''; ?>" />
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="emergencyPersonName" class="form-control form-control-lg" pattern="[A-Za-z]*" oninput="this.value=this.value.replace(/[^A-Za-z]/g,'');" required value="<?php echo isset($parent_dtl['emergency_name']) ? $parent_dtl['emergency_name'] : ''; ?>" />
                                    <div class="invalid-feedback">Please fill name !</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="relationshipWithStudent" class="form-control form-control-lg" oninput="this.value = this.value.replace(/^\s+/g, '');" required value="<?php echo isset($parent_dtl['emergency_relationship']) ? $parent_dtl['emergency_relationship'] : ''; ?>" />
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="personAddress" class="form-control form-control-lg" oninput="this.value = this.value.replace(/^\s+/g, '');" required value="<?php echo isset($parent_dtl['emergency_add']) ? $parent_dtl['emergency_add'] : ''; ?>" />
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="personCity" class="form-control form-control-lg" pattern="[A-Za-z]*" oninput="this.value=this.value.replace(/[^A-Za-z]/g,'');" required value="<?php echo isset($parent_dtl['emergency_city']) ? $parent_dtl['emergency_city'] : ''; ?>" />
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div data-mdb-input-init class="form-outline">
                                    ...
                                    <input type="text" name="personPincode" class="form-control form-control-lg" pattern="\d{6}" maxlength="6" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required value="<?php echo isset($parent_dtl['emergency_pincode']) ? $parent_dtl['emergency_pincode'] : ''; ?>" />
